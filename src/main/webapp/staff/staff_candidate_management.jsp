...
<div class="row">
    <div class="container">
        ...
        <div class="input-group input-group-sm mb-3">
            ...
            <input type="submit" class="btn-check" formaction="${pageContext.request.contextPath}/staff/candidate_management"
            ...
            <a href="${pageContext.request.contextPath}/staff/candidate_management/add_candidate" class="btn btn-info">Add New Candidate</a>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="candidate" items="${listCandidates}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/staff/candidate_management/update_candidate?candidate_id=<c:out value='${candidate.id}' />">Edit</a>
                        <a href="${pageContext.request.contextPath}/staff/candidate_management/delete_candidate?candidate_id=<c:out value='${candidate.id}' />">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
