...
<form class="needs-validation" novalidate
      action="${pageContext.request.contextPath}/party/candidate_management/update_candidate" method="post">
    </c:if>
    <c:if test="${candidate == null}">
    <form class="needs-validation" novalidate
          action="${pageContext.request.contextPath}/party/candidate_management/add_candidate" method="post">
        </c:if>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="party_id" class="form-select" id="party" required>
                            <option selected value="${current_party.id}">${current_party.name}</option>
                        </select>
                    </div>
                    <c:if test="${candidate != null}">
                        <div class="col-md-3">
                            ...
                            <button type="submit" class="btn btn-danger"
                                    formaction="${pageContext.request.contextPath}/party/candidate_management/delete_candidate_from_seat">Delete</button>
                        </div>
                    </c:if>
                    <c:if test="${candidate != null}">
                        <div class="col-md-3">
                            ...
                            <button type="submit" class="btn btn-danger" formaction="${pageContext.request.contextPath}/party/candidate_management/delete_candidate_from_election">Delete</button>
                        </div>
                    </c:if>
                    <br>
